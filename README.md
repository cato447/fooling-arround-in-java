...
| LanguageDecryption | Analyses the frequenzy of every character and decrypts <br> the encrypted text based on the analysis <br> Only supports german texts with 10.000+ words | |
| Tools | | |
| TicTacToe - MinMax | | |
| out | | |
